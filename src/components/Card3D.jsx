...
export default function Card3D({ card, interactive = true, size = 'md' }) {
  ...
  useEffect(() => {
    function updateScale() {
      ...
      const available = parent ? parent.getBoundingClientRect().width : window.innerWidth - 32
      const s = available > 0 && available < dims.width ? available / dims.width : 1
      setScale(s)
    }
    updateScale()
  ...
  return (
    <div ref={wrapperRef}
      style={{ width: dims.width * scale, height: dims.height * scale, flexShrink: 0 }}
    >
      <div style={{
        width: dims.width,
        height: dims.height,
            ...
            <div className="card-face card-face-back" style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: 'cursive', fontSize: dims.nameSize + 2, color: '#555', opacity: 0.6 }}>
